...
public class ServerHandle
{
    ...
    {
        Quaternion _rotation = _packet.ReadQuaternion();
        Server.clients[_fromClient].player.gun.transform.localRotation = _rotation;
        ServerSend.CameraRotation(_fromClient, _rotation);
    }
    ...
    {
        Quaternion _shootDirection = _packet.ReadQuaternion();
